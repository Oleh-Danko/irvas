...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var modalState = {};
  var deadline = '2022-11-20';
  Object(_modules_changeModalStte__WEBPACK_IMPORTED_MODULE_4__["default"])(modalState);
...
/***/ "./src/js/modules/changeModalStte.js":
/*!*******************************************!*\
  !*** ./src/js/modules/changeModalStte.js ***!
  \*******************************************/
...
var changeModalState = function changeModalState(state) {
  ...
  function bindActionToElems(event, elem, prop) {
    elem.forEach(function (item, num) {
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  var block = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 'block';
...
var timer = function timer(id, deadline) {
  ...
  var getTimereamaining = function getTimereamaining(endtime) {
  ...
  var setClock = function setClock(selector, endtime) {
    ...
    function upDateClock() {
      var t = getTimereamaining(endtime);
